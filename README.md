...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/objprint-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14355&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/objprint-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `objprint` can be installed with:

```
conda install objprint
```

It is possible to list all of the versions of `objprint` available on your platform with:
